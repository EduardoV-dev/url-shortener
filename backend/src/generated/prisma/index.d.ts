...
export namespace Prisma {
  ...
  */
  ...
  export type UrlOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"createdAt" | "id" | "originalUrl" | "shortCode" | "clickCount", ExtArgs["result"]["url"]>
  ...
  export interface UrlDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const urlWithCreatedAtOnly = await prisma.url.findMany({ select: { createdAt: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Urls and only return the `createdAt`
     * const urlWithCreatedAtOnly = await prisma.url.createManyAndReturn({
     ...
     * })
     * 
     * // Update zero or more Urls and only return the `createdAt`
     * const urlWithCreatedAtOnly = await prisma.url.updateManyAndReturn({
     *   select: { createdAt: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface UrlFieldRefs {
    ...
    readonly clickCount: FieldRef<"Url", 'Int'>
  }
  ...
  export type UrlScalarWhereWithAggregatesInput = {
    ...
    clickCount?: IntWithAggregatesFilter<"Url"> | number
  }
